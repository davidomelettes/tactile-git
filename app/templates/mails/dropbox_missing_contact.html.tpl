												...
												<td>
													<table width="490" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td valign="middle" width="452"><p style="font-family: Arial; font-size: 24px; font-weight: bold; padding: 0; margin: 0 0 0 25px; color: #333333;">Contact Missing</p></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td>
													<table width="490" cellspacing="0" cellpadding="0" style="border-top: 1px solid #CCCCCC;">
														<tr>
															<td>
																<p style="font-family: Arial; font-size: 12px; color: #333; margin: 25px 0 10px 0; padding: 0;">We cannot find a contact with the email address {$recipient} to attach the email with the subject '{$subject}' to.</p>
																<p style="font-family: Arial; font-size: 12px; color: #333; margin: 0 0 10px 0; padding: 0;">You can <a href="http://{$domain}.tactilecrm.com/emails/assign/{$email_id}">login to Tactile CRM</a>, attach it to an existing contact, create a new contact to attach it to, or delete it from the system.</p>
