												...
												<td>
													<table width="490" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td valign="middle" width="452"><p style="font-family: Arial; font-size: 24px; font-weight: bold; padding: 0; margin: 0 0 0 25px; color: #333333;">Your Activity Has Been Completed</p></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td>
													<table width="490" cellspacing="0" cellpadding="0" style="border-top: 1px solid #CCCCCC;">
														<tr>
															<td>
																<p style="font-family: Arial; font-size: 12px; color: #333; margin: 25px 0 10px 0; padding: 0;">We just wanted to let you know that <strong>{$Activity->getFormatted('alteredby')}</strong> has completed an activity assigned to you: '<a href="http://{$smarty.server.HTTP_HOST}/activities/view/{$Activity->id}">{$Activity->name}</a>'.</p>
