...
SELECT e.id, e.person_id, e.company_id, e.email_from, e.email_to, e.subject, e.body, e.received, e.created, e."owner", e.usercompanyid, c.name AS company, (p.firstname::text || ' '::text) || p.surname::text AS person, 
        CASE
