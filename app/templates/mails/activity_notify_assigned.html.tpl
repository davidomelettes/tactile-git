												...
												<td>
													<table width="490" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td valign="middle" width="452"><p style="font-family: Arial; font-size: 24px; font-weight: bold; padding: 0; margin: 0 0 0 25px; color: #333333;">You've Been Assigned a New Activity</p></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td>
													<table width="490" cellspacing="0" cellpadding="0" style="border-top: 1px solid #CCCCCC;">
														<tr>
															<td>
																<p style="font-family: Arial; font-size: 12px; color: #333; margin: 25px 0 10px 0; padding: 0;">We just wanted to let you know that <strong>{$Activity->getFormatted('assigned_by')}</strong> has assigned an activity for you to complete. A summary follows (or you can <a href="http://{$smarty.server.HTTP_HOST}/activities/view/{$Activity->id}">view the whole thing</a>):</p>
																<p style="font-family: Arial; font-size: 12px; color: #333; margin: 0 0 10px 0; padding: 0;">
Activity: <strong>{$Activity->name}</strong><br />
{if $Activity->isEvent()}
Starts: <strong>{$Activity->date_string()}</strong><br />
Ends: <strong>{$Activity->end_date_string()}</strong>
{else}
Due: <strong>{$Activity->date_string()}</strong>
{/if}
</p>
