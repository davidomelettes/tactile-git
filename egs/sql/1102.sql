...
ALTER TABLE tickets ADD COLUMN usercompanyid bigint;
ALTER TABLE tickets ADD CONSTRAINT tickets_usercompanyid_fkey FOREIGN KEY (usercompanyid) REFERENCES company(id);
COMMIT;