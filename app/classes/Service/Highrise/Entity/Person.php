...
class Service_Highrise_Entity_Person extends Service_Highrise_Entity{
	...
	public function getNotes(){
		if(is_null($this->_noteCollection)){
			...
			$this->_noteCollection->fetchAll(array('type'=>'people','id'=>(string)$this->id));
		}
	...
	public function getEmails(){
		if(is_null($this->_emailCollection)){
			...
			$this->_emailCollection->fetchAll(array('type'=>'people','id'=>(string)$this->id));
		}
